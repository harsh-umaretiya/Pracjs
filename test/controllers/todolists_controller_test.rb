...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { Desc: @todolist.Desc, Title: @todolist.Title } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { Desc: @todolist.Desc, Title: @todolist.Title } }
